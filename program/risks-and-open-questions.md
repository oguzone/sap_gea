...
| S11 | `PartnerPassCode` ve `AccountantUserPassword` SECSTORE'a nasıl yazılacak/okunacak — gerçek SAP SECSTORE/STRUST API'si (sürüme bağlı, bkz. S7) henüz wiring edilmedi (`ZCL_ZONE_IARC_BASE->read_secret` bilerek exception fırlatıyor) | Adapter gerçek ortamda çalışamaz bu olmadan | `[?]` |
